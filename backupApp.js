...
const { PanGestureDetector, State } = GestureDetector;
...
export default class App extends React.Component {
  ...
  render() {
    return (
      <GestureDetector gesture={panGesture} onHandlerStateChange={this._onPan} enabled={this.state.enabled}>
